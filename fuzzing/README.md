...
/ledger-secure-sdk/fuzzing/local_run.sh --build=1 --re-generate-macros=0 --TARGET_DEVICE=stax --BOLOS_SDK=/ledger-secure-sdk/ --fuzzer=build/fuzz_dispatcher --j=4 --run-fuzzer=1 --compute-coverage=1
```
